...
public class Proxy {
    private static final Class<?> cellClass;
    private static final MethodHandle cellGetSymbol;

    private static final Class<?> simulationClass;
    private static final MethodHandle simulationTick;
    private static final MethodHandle simulationCells;
    private static final MethodHandle simulationConstructor;

    private static final MethodHandle plant;
    private static final MethodHandle hamster;
    private static final MethodHandle pingu;
    private static final MethodHandle wolf;
    ...
    static {
        try {
            ...
            simulationConstructor = simulationLookup.findConstructor(
                    simulationClass,
            ...
            hamster = hamsterLookup.findConstructor(hamsterClass, MethodType.methodType(void.class));

            var pinguClass = Proxy.class.getClassLoader().loadClass("pgdp.sim.Pingu");
            ...
            var wolfClass = Proxy.class.getClassLoader().loadClass("pgdp.sim.Wolf");
    ...
    static void tick(Object simulation) throws Throwable {
        simulationTick.invoke(simulation);
    }

    static Object[] getCells(Object simulation) throws Throwable {
    ...
    static Object[] newCellArray(int i) {
        return (Object[]) Array.newInstance(cellClass, i);
    }
